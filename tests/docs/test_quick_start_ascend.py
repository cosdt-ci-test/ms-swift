...
DOC_CN = REPO_ROOT / 'docs' / 'source' / 'GetStarted' / 'Quick-start-Ascend.md'
DOC_EN = REPO_ROOT / 'docs' / 'source_en' / 'GetStarted' / 'Quick-start-Ascend.md'
...
def resolve_doc_path() -> Path:
    for p in (DOC_CN, DOC_EN):
        if p.exists():
            return p
    raise FileNotFoundError(
        f'Quick Start doc not found at {DOC_CN} or {DOC_EN}')
